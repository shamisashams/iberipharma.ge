...
@section('wrapper')
    ...
    <section class="contact_body locations wrapper">
        ...
        <div class="cities">
            ...
            <button class="city_picks">@lang('client.khashuri')</button>
        ...
        <div class="each_city_content">
            ...
            <div class="location_grid">
                <div class="flex">
                    ...
                    <div>
                        <span class="medium">@lang('client.georgia_khashuri')</span> @lang('client.ქ.ხაშური,_რუსთაველის_ქ.N59')
                        <br />
                        <span class="tel">@lang('client.579_372_897')</span>
                    </div>
                </div>
            </div>
            <div class="map">
                <iframe
                        src="https://www.google.com/maps/d/u/0/embed?mid=1eI7czyGOjuZE4rvriQbvaYc2MghYeNJK"
                        width="640"
                        height="480"
                ></iframe>
            </div>
        ...
        <div class="each_city_content">
            ...
            <div class="location_grid">
                ...
                <div class="flex">
                    ...
                    <div>
                        <span class="medium">@lang('client.georgia_gori')</span> @lang('client.ქ.გორი,გურამიშვილის_ქ.N84')
                        <br />
                        <span class="tel">@lang('client.568_714_931')</span>
                    </div>
                </div>
            </div>
            <div class="map">
        ...
        <div class="each_city_content">
            ...
            <div class="location_grid">
                <div class="flex">
                    ...
                    <div>
                        <span class="medium">@lang('client.georgia_zestafoni')</span> @lang('client.ქ.ზესტაფონი,_აღმაშენებლის_ქ.N39ა')
                        <br />
                        <span class="tel">@lang('client.568_714_608')</span>
                    </div>
                </div>
                <div class="flex">
                    <svg
