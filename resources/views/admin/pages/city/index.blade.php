            ...
            <div id="button-trigger" class="card card card-default scrollspy">
                ...
                <div class="card-content">
                    <a class="btn-floating btn-large primary-text gradient-shadow compose-email-trigger "
                       href="{{locale_route('city.create')}}">
                        <i class="material-icons">add</i>
                    </a>
                    <h4 class="card-title mt-2">@lang('admin.city')</h4>
                    <div class="row">
                        <div class="col s12">
                            <form class="mr-0 p-0">
                                    ...
                                    @if($cities)
                                        @foreach($cities as $city)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{locale_route('city.show',$city->id)}}">
                                                        <i class="material-icons">remove_red_eye</i>
                                                    </a>
                                                    <a href="{{locale_route('city.edit',$city->id)}}"
                                                       class="pl-3">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <a href="{{locale_route('city.destroy',$city->id)}}"
                            ...
                            {{ $cities->appends(request()->input())->links('admin.vendor.pagination.material') }}
                        </div>
                    </div>
                </div>
            </div>
