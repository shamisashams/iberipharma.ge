...
{{-- page title --}}
@section('title',__('admin.certificate'))
            ...
            <div id="button-trigger" class="card card card-default scrollspy">
                ...
                <div class="card-content">
                    <a class="btn-floating btn-large primary-text gradient-shadow compose-email-trigger "
                       href="{{locale_route('certificate.create')}}">
                        <i class="material-icons">add</i>
                    </a>
                    <h4 class="card-title mt-2">@lang('admin.certificate')</h4>
                    <div class="row">
                        <div class="col s12">
                            <form class="mr-0 p-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col s12">
                                                            <ul class="tabs">
                                                                @foreach($certificate->languages as $key => $language)
                                                                    @if(isset($languages[$language->language_id]))
                                                                        <li class="tab ">
                                                                            <a href="#cat-{{$certificate->id}}-{{$language->language_id}}">
                                                        ...
                                                        <div class="col sm12 mt-2">
                                                            @foreach($certificate->languages as $key => $language)
                                                                @if(isset($languages[$language->language_id]))
                                                                    <div id="cat-{{$certificate->id}}-{{$language->language_id}}"
                                                                         class="">
                                                                        {{$language->title}}
                                                                    </div>
                                                                @endif
                                                ...
                                                <td>
                                                    <a href="{{locale_route('certificate.show',$certificate->id)}}">
                                                        <i class="material-icons">remove_red_eye</i>
                                                    </a>
                                                    <a href="{{locale_route('certificate.edit',$certificate->id)}}"
                                                       class="pl-3">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <a href="{{locale_route('certificate.destroy',$certificate->id)}}"
                            ...
                            {{ $certificates->appends(request()->input())->links('admin.vendor.pagination.material') }}
                        </div>
                    </div>
                </div>
            </div>
