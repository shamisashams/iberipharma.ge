...
{{-- page title --}}
@section('title', $wellness->language()->name)
                ...
                <div class="display-flex media">
                    <div class="media-body">
                        <h6 class="media-heading">
                            <span class="users-view-name">{{$wellness->language()->name}} </span>
                        </h6>
                    </div>
                </div>
            </div>
            <div class="col s12 m5 quick-action-btns display-flex justify-content-end align-items-center pt-2">
                <a href="{{locale_route('wellness.edit',$wellness->id)}}" class="btn-small indigo">
                    @lang('admin.edit')
                </a>
                <a class="btn-small -settings waves-effect -light -btn right ml-3"
                   href="{{locale_route('wellness.destroy',$wellness->id)}}"
                ...
                <div class="col s12 m4">
                    <table class="striped">
                        ...
                        <tr>
                            ...
                            <td>{{\Carbon\Carbon::parse($wellness->created_at)}}</td>
                        </tr>
                        <tr>
                            <td>@lang('admin.updated_at')</td>
                            <td>{{\Carbon\Carbon::parse($wellness->updated_at)}}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="section">
                <div class="masonry-gallery-wrapper">
                    <div class="popup-gallery">
                        ...
                        <div class="row">
                            @foreach($wellness->files as $file)
